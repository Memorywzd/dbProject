...
public class Attendance {
    ...
    public void setrateAssistantID(int attendanceType) {
    ...
    public String getAttendanceBudget() {
        return attendanceBudget;
    }

    public void setAttendanceBudget(String attendanceBudget) {
        this.attendanceBudget = attendanceBudget;
    }
}
